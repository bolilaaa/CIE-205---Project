...
void GUI::PrintMessage(string msg) const	//Prints a message on status bar
{
	...
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight/1.01), msg); // You may need to change these coordinates later 
...
void GUI::PrintMessage2(string msg) const  //Prints a message on status bar
{
	...
	pWind->DrawString(10, WindHeight - 1 - (int)(StatusBarHeight / 1.15), msg); // You may need to change these coordinates later 
										// to be able to write multi-line
}
void GUI::PrintMessage3(string msg) const  //Prints a message on status bar
{

	pWind->DrawString(10, WindHeight - 1 - (int)(StatusBarHeight / 1.35), msg); // You may need to change these coordinates later 
										// to be able to write multi-line
}
void GUI::PrintMessage4(string msg) const  //Prints a message on status bar
{

	pWind->DrawString(10, WindHeight - 1 - (int)(StatusBarHeight / 1.65), msg); // You may need to change these coordinates later 
										// to be able to write multi-line
}
void GUI::PrintMessage5(string msg) const  //Prints a message on status bar
{

	pWind->DrawString(10, WindHeight - 1 - (int)(StatusBarHeight / 2.1), msg); // You may need to change these coordinates later 
										// to be able to write multi-line
}
//////////////////////////////////////////////////////////////////////////////////////////
...
PROG_MODE	GUI::getGUIMode() const
{
	...
	do
	{
		PrintMessage("Please select GUI mode: (1)Interactive, (2)StepByStep, (3)Silent, (4)Simulation... ");
		string S = GetString();
