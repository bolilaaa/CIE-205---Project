...
{
	ptr = waitingVIPOrders.top();
	waitingVIPOrders.pop();
}


/////// remove service ///////***
void Restaurant::rmvsrvNOROrders()
{
	srvNOROrders.pop();
}

void Restaurant::rmvsrvVEGOrders()
{
	srvVEGOrders.pop();
}

void Restaurant::rmvsrvCHNOrders()
{
	srvCHNOrders.pop();
}

void Restaurant::rmvsrvMEXOrders()
{
	srvMEXOrders.pop();
}

void Restaurant::rmvsrvVIPOrders()
{
	srvVIPOrders.pop();
}
